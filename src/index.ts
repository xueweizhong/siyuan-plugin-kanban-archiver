...
import { archiveKanbanTasks, restoreKanbanTasks, resolveProfileAvInfo } from "./api/kanban";
...
export default class KanbanWorkflowPlugin extends Plugin {
    ...
    // Undo Stack: { date: number, ids: Array<{ profileId: string, avId: string, itemId: string } | string> }[]
